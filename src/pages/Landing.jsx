...
export default function Landing() {
  return (
    <div className="auth-bg" style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      {/* Navigation */}
      <nav style={{ padding: '24px 48px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', position: 'relative', zIndex: 2 }}>
      ...
      {/* Hero Section */}
      <main style={{ flex: 1, display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', padding: '64px 48px', textAlign: 'center', position: 'relative', zIndex: 2 }}>
        ...
        <h1 className="stagger-2" style={{ fontSize: '68px', maxWidth: '900px', lineHeight: 1.05, marginBottom: '24px', letterSpacing: '-2px' }}>
        ...
        <div className="stagger-4" style={{ display: 'flex', gap: '24px', marginBottom: '80px' }}>
          <Link to="/login" className="btn-primary" style={{ padding: '18px 48px', fontSize: '20px', textDecoration: 'none' }}>
            Start Studying Now <ArrowRight size={22} />
          </Link>
          <button className="btn-secondary" style={{ padding: '18px 48px', fontSize: '20px' }}>See How It Works</button>
        </div>
        ...
        <div className="layout-grid" style={{ width: '100%', maxWidth: '1200px', textAlign: 'left' }}>
          {[
            ...
            <div key={i} className="sticker-card" style={{ gridColumn: 'span 4', padding: '32px', display: 'flex', flexDirection: 'column', gap: '16px', animation: `fadeInUp 0.5s ease-out ${0.2 + i * 0.1}s both` }}>
